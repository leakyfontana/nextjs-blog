...
export default function Wave(Props: WaveProps) {
    ...
    <svg className={utilStyles.wave} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        ...
        192,663,128,686,96C708.6,64,731,64,754,101.3C777.1,139,800,213,823,218.7C845.7,224,869,
        160,891,154.7C914.3,149,937,203,960,213.3C982.9,224,1006,192,1029,192C1051.4,192,1074,
        224,1097,213.3C1120,203,1143,149,1166,154.7C1188.6,160,1211,224,1234,261.3C1257.1,299,
        1280,309,1303,309.3C1325.7,309,1349,299,1371,282.7C1394.3,267,1417,245,1429,234.7L1440,
        224L1440,320L1428.6,320C1417.1,320,1394,320,1371,320C1348.6,320,1326,320,1303,320C1280,
        320,1257,320,1234,320C1211.4,320,1189,320,1166,320C1142.9,320,1120,320,1097,320C1074.3,
        320,1051,320,1029,320C1005.7,320,983,320,960,320C937.1,320,914,320,891,320C868.6,320,
        846,320,823,320C800,320,777,320,754,320C731.4,320,709,320,686,320C662.9,320,640,320,
