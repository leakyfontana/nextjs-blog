...
export default function Record() {
      ...
      <>
        {
         ...
         ( <p>Loading...</p> ) : (
...

          {
            ...
            (
              <>
                  <g className={styles.record}>
                    <circle className={styles.disk} fill={recordColor} r="180" cx="200" cy="200" />
                    <circle className={styles.line} fill={recordColor} stroke={recordLineColor} r="160" cx="200" cy="200" />
                    <circle className={styles.line} fill={recordColor} stroke={recordLineColor} r="140" cx="200" cy="200" />
                    <circle className={styles.line} fill={recordColor} stroke={recordLineColor} r="120" cx="200" cy="200" />
            ...
            <button className={utilStyles.boatButton} onClick={() => signOut()}>
              <span className={utilStyles.buttonText}>Sign Out</span>
              <svg viewBox="105.311 289.254 175.846 54.952" width="175.846" height="54.952">
              <defs>
          ...
          <div className={utilStyles.card}>
            <h2 className={utilStyles.headingxL}>Now Playing: </h2>
            <h3 className={utilStyles.headingLg}>currentSong.name</h3>
            <h3 className={utilStyles.headingLg}>By: currentSong.artists.join(", ")</h3>
          </div>
  ...
  return (
    <>
      Not signed in <br />
      <Link href="/login">
        <button className={utilStyles.boatButton}>
          <span className={utilStyles.buttonText}>Log In</span>
          <svg className={utilStyles.shadow} viewBox="105.311 289.254 175.846 54.952" width="175.846" height="54.952">
          <defs>
            <pattern id="pattern-0-0" patternTransform="matrix(1.068461, 0, 0, 1.091886, 114.480534, 303.348586)" xlinkHref="#pattern-0"></pattern>
            <pattern x="0" y="0" width="25" height="25" patternUnits="userSpaceOnUse" viewBox="0 0 100 100" id="pattern-0">
              <rect x="3.169" y="2.041" width="16.436" height="100.196" fill='#064273' transform="matrix(0, 1, -1, 0, 102.132065, 80.469963)"></rect>
