export const Projects  = [
    {
        ...
        a list of their Confirmed Flex Cals with a button to add their corresponding booking links to the session
        clipboard`,
    },
    {
        ...
        several visual components showcasing + marketing Sid's work and an interactive form to submit a booking request.`,
    },
    {
        ...
        presented with an interactive component resembling a record player that updates dynamically according to whatever
