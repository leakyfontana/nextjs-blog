        ...
        <>
            <div className="fixed top-3 right-5 flex flex-col gap-0.5 pt-3 px-2 cursor-pointer z-30" onClick={toggleNav}>
                <svg className="w-14" viewBox="310 190 200 150" xmlns="http://www.w3.org/2000/svg">
                    <g className={`duration-1000 ${isToggle ? `${styles.board1} origin-right`: ''}`}>
                    ...
                    <g className={`duration-1000 ${isToggle ? `${styles.board2} origin-left`: ''}`}>
                ...
                {/* <svg className='w-12 rotate-180' viewBox="321.85 262.692 174.711 40.408" xmlns="http://www.w3.org/2000/svg">
                </svg> */}
                {/* <svg className='w-12' viewBox="321.85 262.692 174.711 40.408" xmlns="http://www.w3.org/2000/svg">
                    <path d="M 495.958 282.996 C 495.958 293.697 454.178 302.373 402.639 302.373 C 369.597 302.373 340.566 298.807 323.984 
                    293.428 L 331.265 283.013 L 323.621 272.681 C 340.139 267.235 369.354 263.617 402.639 263.617 C 454.178 263.617 495.958 
                    272.293 495.958 282.996 Z" fill="rgb(244, 248, 243)"  stroke="rgb(5, 66, 115)"/>
                    <line fill="rgb(216, 216, 216)" stroke="rgb(5, 66, 115)" x1="496.137" y1="283.119" x2="379.211" y2="283.199"/>
                    <ellipse fill="rgb(194, 178, 128)" stroke="rgb(5, 66, 115)" cx="458.305" cy="283.238" rx="2.46" ry="2.382"/>
                </svg> */}
            </div>
            <div className={`fixed top-0 z-20 w-6/12 h-full left-1/2 bg-seafoam duration-700 ${isToggle ? '': 'translate-x-full'}`}>
